...
class Instagram {
   ...
   * Get recent media from a given location
   *
   * @param string $f4_v2_id             Foursquare v2 api location id
   * @param integer [optional] $distance  Distance in meter (max. distance: 5km = 5000)
   * @return mixed
   */
  public function searchLocationF4($f4_v2_id, $distance = 1000) {
    return $this->_makeCall('locations/search', false, array('foursquare_v2_id' => $f4_v2_id, 'distance' => $distance));
  }
